...
urlpatterns = patterns('',
    ...
    url(r'^rutas/$', 'ladder.views.rutas', name="rutas"),
    url(r'^tipos-de-rutas/$', 'ladder.views.tipos', name="tipos"),
	...
	url(r'^no-encuentras-tu-cargo/$','ladder.views.nocargo', name="nocargo"),
